 ...
 */
//
angular.module('sbAdminApp').factory('api', ['$rootScope', '$http',
    '$cookieStore',
    function($rootScope, $http, $cookieStore) {
        // var parseUrl = 'http://localhost:3000/api2';
        var parseUrl = "http://modp.qykly.mobi/api2";
        // var parseUrl = '/api2';
        ...
        return {
            ...
            put: function(theClass, object, token, data, callback) {
                $http.put(GenerateUrl(theClass, object, false), data, {
                    ...
                    callback(true, response ||
                        'There is some problem with your data.');
                });
            },
            ...
            get: function(theClass, object, token, query, callback) {
                ...
                $http.get(GenerateUrl(theClass, object, false), config).success(
                    function(response) {
                        callback(null, response);
                    }).error(function(response) {
