...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      //shweta
      submitTpl:    '<button class="btn btn-primary" type="button"><span class="glyphicon glyphicon-ok"></span></button>',
      // cancelTpl:    '<button type="button" ng-click="$form.$cancel()">cancel</button>'
      //shweta
      cancelTpl:    '<button class="btn btn-default" type="button" ng-click="$form.$cancel()"><span class="glyphicon glyphicon-remove"></span></button>'
    },
